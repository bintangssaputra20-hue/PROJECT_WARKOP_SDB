...
<script>
// Tangkap Token CSRF dari Head HTML
...
btnKonfirmasi.addEventListener("click", function() {
    ...
    if (metode === "Tunai") {
        imgInstruksi.src = "{{ asset('img/9902534.jpg') }}";
        teksInstruksi.innerText = "Silahkan menuju kasir";
    } else {
        imgInstruksi.src = "{{ asset('img/YjQnEfvec3Xgemn9e4syHf.png') }}";
...
closeBtn.onclick = function() {
    ...
    window.location.href = "/halaman-struk"; // Arahkan ke rute Laravel berikutnya
};
</script>
</body>
</html>